...
<div class="joinbox">
	<form action="member/step3" method="post">
		<div class="formbox">
			<label>아이디</label>
			<input type="text" name="memId"  placeholder="아이디(8-30자이내)" style="text-align:center; font-size:15px; width:200px; height:35px;"/><br/> <!-- style수정하셔도 됩니다 -->
			<input type="password" name="memPwd" id="memPwd" placeholder="비밀번호(8-30자이내)" style="text-align:center; font-size:15px; width:200px; height:35px;"/><br/> 
			...
			<input type="text" name="memName" placeholder="이름" style="text-align:center; font-size:15px; width:200px; height:35px;"/><br/>
			<input type="text" name="memNickName" placeholder="닉네임" style="text-align:center; font-size:15px; width:200px; height:35px;"/><br/> 
			<input type="email" name="memEmail" placeholder="이메일" style="text-align:center; font-size:15px; width:200px; height:35px;"/><br/>
